(function(){
  ...
  function applyHeroContent(heroConfig, lang){
    ...
    const imageSrc = data.image || heroConfig.en?.image || heroConfig.image || 'hero.svg';
  ...
  function createCategoryCard(item, lang){
    ...
    const imageSrc = item?.image || 'store.svg';
  ...
  function applyAboutContent(aboutConfig, lang){
    ...
    setImageKey('about.founder.image', founder.image || 'model1.svg');
